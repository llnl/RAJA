...
concept ExecutionPolicy =
    RAJA::type_traits::is_same_strip_const_v<decltype(Pol::policy),
                                             ::RAJA::Policy> &&
    RAJA::type_traits::is_same_strip_const_v<decltype(Pol::pattern),
                                             ::RAJA::Pattern> &&
    RAJA::type_traits::is_same_strip_const_v<decltype(Pol::launch),
                                             ::RAJA::Launch> &&
    RAJA::type_traits::is_same_strip_const_v<decltype(Pol::platform),
                                             ::RAJA::Platform>;
