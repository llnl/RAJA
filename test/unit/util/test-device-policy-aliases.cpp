...
static_assert(std::is_same_v<RAJA::device_exec<128, false>,
                             RAJA::RAJA_DEVICE_ALIAS(exec)<128, false>>,
              "device_exec should map to the active GPU backend");
static_assert(std::is_same_v<RAJA::device_launch_t<false>,
                             RAJA::RAJA_DEVICE_ALIAS(launch_t)<false>>,
              "device_launch_t should map to the active GPU backend");
static_assert(std::is_same_v<RAJA::device_global_size_x_direct<64>,
                             RAJA::RAJA_DEVICE_ALIAS(global_size_x_direct)<64>>,
              "device_global_size_x_direct should map to the active GPU backend");
static_assert(std::is_same_v<RAJA::device_thread_x_direct,
                             RAJA::RAJA_DEVICE_ALIAS(thread_x_direct)>,
              "device_thread_x_direct should map to the active GPU backend");
static_assert(std::is_same_v<RAJA::device_block_x_loop,
                             RAJA::RAJA_DEVICE_ALIAS(block_x_loop)>,
              "device_block_x_loop should map to the active GPU backend");

#elif defined(RAJA_SYCL_ACTIVE)
static_assert(std::is_same_v<RAJA::device_exec<128, false>,
                             RAJA::sycl_exec<128, false>>,
              "device_exec should map to sycl_exec when RAJA_SYCL_ACTIVE");
static_assert(std::is_same_v<RAJA::device_atomic, RAJA::sycl_atomic>,
              "device_atomic should map to sycl_atomic when RAJA_SYCL_ACTIVE");
static_assert(std::is_same_v<RAJA::device_atomic_explicit<RAJA::seq_atomic>,
                             RAJA::sycl_atomic_explicit<RAJA::seq_atomic>>,
              "device_atomic_explicit should map to sycl_atomic_explicit");
static_assert(std::is_same_v<RAJA::device_reduce, RAJA::sycl_reduce>,
...
static_assert(std::is_same_v<RAJA::device_global_thread_x,
...
static_assert(std::is_same_v<RAJA::device_thread_x_loop,
...
static_assert(std::is_same_v<RAJA::device_flatten_block_threads_xy_direct,
                             RAJA::sycl_flatten_group_local_21_direct>,
              "device_flatten_block_threads_xy_direct should map to sycl flatten");
static_assert(std::is_same_v<RAJA::device_flatten_block_threads_xy_loop,
